...
#ifndef FIREBOLT_RIALTO_WRAPPERS_I_OCDM_SESSION_CLIENT_H_
#define FIREBOLT_RIALTO_WRAPPERS_I_OCDM_SESSION_CLIENT_H_
...
#endif // FIREBOLT_RIALTO_WRAPPERS_I_OCDM_SESSION_CLIENT_H_
