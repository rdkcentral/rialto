...
public:
    ...
    std::shared_ptr<IDeviceSettingsWrapperFactory> &deviceSettingsWrapperFactory() override;
...
private:
    ...
    std::shared_ptr<IDeviceSettingsWrapperFactory> m_deviceSettingsWrapperFactory{nullptr};
};
} // namespace firebolt::rialto::wrappers
