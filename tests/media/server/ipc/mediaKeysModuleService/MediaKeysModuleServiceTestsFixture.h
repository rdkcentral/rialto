...
public:
    ...
    void cdmServiceWillGetExistingKey();
    void cdmServiceWillFailToGetExistingKey();
    void cdmServiceWillSetDrmHeader();
    void cdmServiceWillFailToSetDrmHeader();
    void cdmServiceWillDeleteDrmStore();
    void cdmServiceWillFailToDeleteDrmStore();
    void cdmServiceWillDeleteKeyStore();
    void cdmServiceWillFailToDeleteKeyStore();
    void cdmServiceWillGetDrmStoreHash();
    void cdmServiceWillFailToGetDrmStoreHash();
    void cdmServiceWillGetKeyStoreHash();
    void cdmServiceWillFailToGetKeyStoreHash();
    void cdmServiceWillGetLdlSessionsLimit();
    void cdmServiceWillFailToGetLdlSessionsLimit();
    void cdmServiceWillGetLastDrmError();
    ...
    void sendContainsKeyRequestAndReceiveResponse();
    void sendContainsKeyRequestAndReceiveErrorResponse();
    void sendSetDrmHeaderRequestAndReceiveResponse();
    void sendSetDrmHeaderRequestAndReceiveErrorResponse();
    void sendDeleteDrmStoreRequestAndReceiveResponse();
    void sendDeleteDrmStoreRequestAndReceiveErrorResponse();
    void sendDeleteKeyStoreRequestAndReceiveResponse();
    void sendDeleteKeyStoreRequestAndReceiveErrorResponse();
    void sendGetDrmStoreHashRequestAndReceiveResponse();
    void sendGetDrmStoreHashRequestAndReceiveErrorResponse();
    void sendGetKeyStoreHashRequestAndReceiveResponse();
    void sendGetKeyStoreHashRequestAndReceiveErrorResponse();
    void sendGetLdlSessionsLimitRequestAndReceiveResponse();
    void sendGetLdlSessionsLimitRequestAndReceiveErrorResponse();
    void sendGetLastDrmErrorRequestAndReceiveResponse();
