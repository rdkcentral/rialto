...
class RialtoServerMediaKeysGetDrmStoreHashTest : public MediaKeysTestBase
{
protected:
    std::vector<unsigned char> m_drmStoreHash{};
...
/**
 * Test that GetDrmStoreHash returns success.
 */
...
/**
 * Test that GetDrmStoreHash fails if the session api fails.
 */
