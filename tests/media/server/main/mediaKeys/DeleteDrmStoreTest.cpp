...
class RialtoServerMediaKeysDeleteDrmStoreTest : public MediaKeysTestBase
{
protected:
...
/**
 * Test that DeleteDrmStore returns success.
 */
...
/**
 * Test that DeleteDrmStore fails if the session api fails.
 */
