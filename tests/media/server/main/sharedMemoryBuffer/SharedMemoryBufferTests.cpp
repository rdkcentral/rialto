...
TEST_F(SharedMemoryBufferTests, shouldMapGenericPlaybackSession)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
}
...
TEST_F(SharedMemoryBufferTests, shouldMapWebAudioPlayer)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
}
...
TEST_F(SharedMemoryBufferTests, shouldFailToMapTwoGenericPlaybackSessions)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
    mapPartitionShouldFail(firebolt::rialto::server::MediaPlaybackType::GENERIC, session2);
}
...
TEST_F(SharedMemoryBufferTests, shouldFailToMapTwoWebAudioPlayers)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
    mapPartitionShouldFail(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle2);
}
...
TEST_F(SharedMemoryBufferTests, shouldUnmapGenericPlaybackSession)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
    unmapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
}
...
TEST_F(SharedMemoryBufferTests, shouldUnmapWebAudioPlayer)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
    unmapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
}
...
TEST_F(SharedMemoryBufferTests, shouldMapNewGenericPlaybackSessionAfterUnmapingTheOldOne)
{
    ...
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
    unmapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session2);
}
...
TEST_F(SharedMemoryBufferTests, shouldMapNewWebAudioPlayerAfterUnmapingTheOldOne)
{
    ...
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
    unmapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle2);
}
...
TEST_F(SharedMemoryBufferTests, shouldFailToUnmapNotExistingGenericPlaybackSession)
{
    constexpr int session1{0};
    initialize();
    unmapPartitionShouldFail(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
}
...
TEST_F(SharedMemoryBufferTests, shouldFailToUnmapNotExistingWebAudioPlayer)
{
    constexpr int handle1{0};
    initialize();
    unmapPartitionShouldFail(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
}
...
TEST_F(SharedMemoryBufferTests, shouldNotReturnMaxAudioDataLenForNotMappedGenericPlaybackSession)
{
    constexpr int session1{0};
    initialize();
    shouldFailToReturnMaxAudioDataLen(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
}
...
TEST_F(SharedMemoryBufferTests, shouldNotReturnMaxAudioDataLenForNotMappedWebAudioPlayer)
{
    constexpr int handle1{0};
    initialize();
    shouldFailToReturnMaxAudioDataLen(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
}
...
TEST_F(SharedMemoryBufferTests, shouldReturnZeroForMaxWebAudioVideoDataLen)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
    shouldFailToReturnMaxVideoDataLen(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO,handle1);
}
...
TEST_F(SharedMemoryBufferTests, shouldNotReturnMaxVideoDataLenForNotMappedGenericPlaybackSession)
{
    constexpr int session1{0};
    initialize();
    shouldFailToReturnMaxVideoDataLen(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
}
...
TEST_F(SharedMemoryBufferTests, shouldClearAudioDataForGenericPlaybackSession)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
    shouldClearAudioData(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
}
...
TEST_F(SharedMemoryBufferTests, shouldClearAudioDataForWebAudioPlayer)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
    shouldClearAudioData(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
}
...
TEST_F(SharedMemoryBufferTests, shouldNotClearAudioDataForNotMappedGenericPlaybackSession)
{
    constexpr int session1{0};
    initialize();
    shouldFailToClearAudioData(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
}
...
TEST_F(SharedMemoryBufferTests, shouldNotClearAudioDataForNotMappedWebAudioPlayer)
{
    constexpr int handle1{0};
    initialize();
    shouldFailToClearAudioData(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
}
...
TEST_F(SharedMemoryBufferTests, shouldClearVideoDataForGenericPlaybackSession)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
    shouldClearVideoData(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
}
...
TEST_F(SharedMemoryBufferTests, shouldNotClearVideoDataForNotMappedGenericPlaybackSession)
{
    constexpr int session1{0};
    initialize();
    shouldFailToClearVideoData(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
}
...
TEST_F(SharedMemoryBufferTests, shouldFailToReturnVideoDataOffsetForGenericPlaybackSession)
{
    constexpr int session1{0};
    initialize();
    shouldFailToReturnVideoDataOffset(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
}
...
TEST_F(SharedMemoryBufferTests, shouldFailToReturnVideoDataOffsetForWebAudioPlayer)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
    shouldFailToReturnVideoDataOffset(firebolt::rialto::server::MediaPlaybackType::GENERIC, handle1);
}
...
TEST_F(SharedMemoryBufferTests, shouldFailToReturnAudioDataOffsetForGenericPlaybackSession)
{
    constexpr int session1{0};
    initialize();
    shouldFailToReturnAudioDataOffset(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
}
...
TEST_F(SharedMemoryBufferTests, shouldFailToReturnAudioDataOffsetForWebAudioPlayer)
{
    constexpr int handle1{0};
    initialize();
    shouldFailToReturnAudioDataOffset(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
}
...
TEST_F(SharedMemoryBufferTests, shouldReturnVideoDataOffsetForOneGenericPlaybackSession)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
    shouldReturnVideoDataOffset(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1, expectedOffset);
}
...
TEST_F(SharedMemoryBufferTests, shouldReturnAudioDataOffsetForOneGenericPlaybackSession)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
    shouldReturnAudioDataOffset(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1, expectedOffset);
}
...
TEST_F(SharedMemoryBufferTests, shouldReturnAudioDataOffsetForOneWebAudioPlayer)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
    shouldReturnAudioDataOffset(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1, expectedOffset);
}
...
TEST_F(SharedMemoryBufferTests, shouldReturnVideoDataOffsetForTwoGenericPlaybackSessions)
{
    ...
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session2);
    shouldReturnVideoDataOffset(firebolt::rialto::server::MediaPlaybackType::GENERIC, session2, expectedOffset);
}
...
TEST_F(SharedMemoryBufferTests, shouldReturnAudioDataOffsetForTwoGenericPlaybackSessionsAndTwoWebAudioPlayers)
{
    ...
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle2);
    shouldReturnAudioDataOffset(firebolt::rialto::server::MediaPlaybackType::GENERIC, session2, expectedOffsetSecondGeneric);
    shouldReturnAudioDataOffset(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle2, expectedOffsetSecondWebAudio);
}
...
TEST_F(SharedMemoryBufferTests, shouldFailToGetDataPtrForUnmappedGenericPlaybackSession)
{
    constexpr int session1{0};
    initialize();
    shouldFailToGetDataPtr(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1, firebolt::rialto::MediaSourceType::VIDEO);
    shouldFailToGetDataPtr(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1, firebolt::rialto::MediaSourceType::AUDIO);
}
...
TEST_F(SharedMemoryBufferTests, shouldFailToGetAudioDataPtrForUnmappedWebAudioPlayer)
{
    constexpr int handle1{0};
    initialize();
    shouldFailToGetDataPtr(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1, firebolt::rialto::MediaSourceType::AUDIO);
}
...
TEST_F(SharedMemoryBufferTests, shouldFailToGetVideoDataPtrForWebAudioPlayer)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
    shouldFailToGetDataPtr(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1, firebolt::rialto::MediaSourceType::VIDEO);
}
...
TEST_F(SharedMemoryBufferTests, shouldFailToGetDataPtrForUnknownSourceType)
{
    ...
    initialize();
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
    shouldFailToGetDataPtr(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1, firebolt::rialto::MediaSourceType::UNKNOWN);
}
...
TEST_F(SharedMemoryBufferTests, shouldGetDataPtrForGenericPlaybackSessions)
{
    ...
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1);
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::GENERIC, session2);
    uint8_t *session1Video = shouldGetDataPtr(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1, firebolt::rialto::MediaSourceType::VIDEO);
    uint8_t *session1Audio = shouldGetDataPtr(firebolt::rialto::server::MediaPlaybackType::GENERIC, session1, firebolt::rialto::MediaSourceType::AUDIO);
    uint8_t *session2Video = shouldGetDataPtr(firebolt::rialto::server::MediaPlaybackType::GENERIC, session2, firebolt::rialto::MediaSourceType::VIDEO);
    uint8_t *session2Audio = shouldGetDataPtr(firebolt::rialto::server::MediaPlaybackType::GENERIC, session2, firebolt::rialto::MediaSourceType::AUDIO);
...
TEST_F(SharedMemoryBufferTests, shouldGetAudioDataPtrForWebAudioPlayers)
{
    ...
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1);
    mapPartitionShouldSucceed(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle2);
    uint8_t *handle1Audio = shouldGetDataPtr(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle1, firebolt::rialto::MediaSourceType::AUDIO);
    uint8_t *handle2Audio = shouldGetDataPtr(firebolt::rialto::server::MediaPlaybackType::WEB_AUDIO, handle2, firebolt::rialto::MediaSourceType::AUDIO);
