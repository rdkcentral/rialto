...
#ifndef FIREBOLT_RIALTO_SERVER_WEB_AUDIO_PLAYER_TASK_FACTORY_MOCK_H_
#define FIREBOLT_RIALTO_SERVER_WEB_AUDIO_PLAYER_TASK_FACTORY_MOCK_H_
...
public:
    ...
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createWriteBuffer, (WebAudioPlayerContext &context, IGstWebAudioPlayerPrivate &player, uint8_t *mainPtr, uint32_t mainLength, uint8_t *wrapPtr, uint32_t wrapLength), (const, override));
...
#endif // FIREBOLT_RIALTO_SERVER_WEB_AUDIO_PLAYER_TASK_FACTORY_MOCK_H_
