...
#ifndef FIREBOLT_RIALTO_SERVER_MOCK_GST_SRC_FACTORY_MOCK_H_
#define FIREBOLT_RIALTO_SERVER_MOCK_GST_SRC_FACTORY_MOCK_H_
...
#endif // FIREBOLT_RIALTO_SERVER_MOCK_GST_SRC_FACTORY_MOCK_H_
