...
public:
    ...
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createAttachSource,
                (GenericPlayerContext & context, const std::unique_ptr<IMediaPipeline::MediaSource> &source), (const, override));
    ...
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createEos,
                (GenericPlayerContext & context, IGstGenericPlayerPrivate &player, const firebolt::rialto::MediaSourceType &type),
                (const, override));
    ...
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createHandleBusMessage,
                (GenericPlayerContext & context, IGstGenericPlayerPrivate &player, GstMessage *message), (const, override));
    ...
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createReadShmDataAndAttachSamples,
                (GenericPlayerContext & context, IGstGenericPlayerPrivate &player, const std::shared_ptr<IDataReader> &dataReader),
                (const, override));
    ...
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createSetPosition,
                (GenericPlayerContext & context, IGstGenericPlayerPrivate &player, std::int64_t position), (const, override));
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createSetupElement,
                (GenericPlayerContext & context, IGstGenericPlayerPrivate &player, GstElement *element), (const, override));
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createSetupSource,
                (GenericPlayerContext & context, IGstGenericPlayerPrivate &player, GstElement *source), (const, override));
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createSetVideoGeometry,
                (GenericPlayerContext & context, IGstGenericPlayerPrivate &player, const Rectangle &rectangle), (const, override));
    ...
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createStop, (GenericPlayerContext & context, IGstGenericPlayerPrivate &player),
                (const, override));
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createUnderflow, (IGstGenericPlayerPrivate & player, bool &underflowFlag),
                (const, override));
