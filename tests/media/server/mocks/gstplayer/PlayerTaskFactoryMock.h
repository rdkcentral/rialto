...
public:
    ...
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createAttachSource,
                (PlayerContext & context, const std::unique_ptr<IMediaPipeline::MediaSource> &source), (const, override));
    ...
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createRemoveSource,
                (PlayerContext & context, const firebolt::rialto::MediaSourceType &type), (const, override));
    ...
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createUnderflow,
                (IGstPlayerPrivate & player, bool &underflowFlag, bool underflowEnabled), (const, override));
