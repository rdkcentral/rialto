...
#ifndef FIREBOLT_RIALTO_SERVER_OCDM_SYSTEM_FACTORY_MOCK_H_
#define FIREBOLT_RIALTO_SERVER_OCDM_SYSTEM_FACTORY_MOCK_H_
...
#endif // FIREBOLT_RIALTO_SERVER_OCDM_SYSTEM_FACTORY_MOCK_H_
