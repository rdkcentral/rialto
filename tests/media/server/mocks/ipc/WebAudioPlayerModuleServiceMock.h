...
#ifndef FIREBOLT_RIALTO_SERVER_IPC_WEB_AUDIO_PIPELINE_MODULE_SERVICE_MOCK_H_
#define FIREBOLT_RIALTO_SERVER_IPC_WEB_AUDIO_PIPELINE_MODULE_SERVICE_MOCK_H_
...
public:
    ...
    MOCK_METHOD(void, createWebAudioPlayer, (::google::protobuf::RpcController *controller,
                ...
                (override));
    MOCK_METHOD(void, destroyWebAudioPlayer, (::google::protobuf::RpcController *controller,
                ...
                (override));
    MOCK_METHOD(void, play, (::google::protobuf::RpcController *controller,
                ...
                (override));
    MOCK_METHOD(void, pause, (::google::protobuf::RpcController *controller,
                ...
                (override));
    MOCK_METHOD(void, setEos, (::google::protobuf::RpcController *controller,
                ...
                (override));
    MOCK_METHOD(void, getBufferAvailable, (::google::protobuf::RpcController *controller,
                ...
                (override));
    MOCK_METHOD(void, getBufferDelay, (::google::protobuf::RpcController *controller,
                ...
                (override));
    MOCK_METHOD(void, writeBuffer, (::google::protobuf::RpcController *controller,
                ...
                (override));
    MOCK_METHOD(void, getDeviceInfo, (::google::protobuf::RpcController *controller,
                ...
                (override));
    MOCK_METHOD(void, setVolume, (::google::protobuf::RpcController *controller,
                ...
                (override));
    MOCK_METHOD(void, getVolume, (::google::protobuf::RpcController *controller,
...
#endif // FIREBOLT_RIALTO_SERVER_IPC_WEB_AUDIO_PIPELINE_MODULE_SERVICE_MOCK_H_
