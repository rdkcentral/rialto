...
#ifndef FIREBOLT_RIALTO_CLIENT_MOCK_IPC_CLIENT_MOCK_H_
#define FIREBOLT_RIALTO_CLIENT_MOCK_IPC_CLIENT_MOCK_H_
...
#endif // FIREBOLT_RIALTO_CLIENT_MOCK_IPC_CLIENT_MOCK_H_
