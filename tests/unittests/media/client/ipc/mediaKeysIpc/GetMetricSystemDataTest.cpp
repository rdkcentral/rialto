...
/**
 * Test getMetricSystemData success.
 */
TEST_F(RialtoClientMediaKeysIpcGetMetricSystemDataTest, Success)
{
...
/**
 * Test that getMetricSystemData fails if the ipc channel disconnected.
 */
TEST_F(RialtoClientMediaKeysIpcGetMetricSystemDataTest, ChannelDisconnected)
{
    std::vector<uint8_t> buffer;
...
/**
 * Test that getMetricSystemData fails if the ipc channel disconnected and succeeds if the channel is reconnected.
 */
TEST_F(RialtoClientMediaKeysIpcGetMetricSystemDataTest, ReconnectChannel)
{
    std::vector<uint8_t> buffer;
...
/**
 * Test that getMetricSystemData fails when ipc fails.
 */
