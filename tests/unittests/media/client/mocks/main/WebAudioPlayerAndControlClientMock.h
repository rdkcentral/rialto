...
#ifndef FIREBOLT_RIALTO_CLIENT_WEB_AUDIO_PLAYER_AND_CONTROL_CLIENT_MOCK_H_
#define FIREBOLT_RIALTO_CLIENT_WEB_AUDIO_PLAYER_AND_CONTROL_CLIENT_MOCK_H_
...
{
class WebAudioPlayerAndControlClientMock : public IWebAudioPlayerAndIControlClient
{
public:
...
#endif // FIREBOLT_RIALTO_CLIENT_WEB_AUDIO_PLAYER_AND_CONTROL_CLIENT_MOCK_H_
