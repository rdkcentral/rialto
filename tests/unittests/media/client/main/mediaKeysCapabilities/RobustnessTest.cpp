...
class RialtoClientMediaKeysCapabilitiesRobustnessTest : public ::testing::Test
{
protected:
    ...
    RialtoClientMediaKeysCapabilitiesRobustnessTest()
...
/**
 * Test that getSupportedRobustnessLevels returns success and forwards the IPC result.
 */
TEST_F(RialtoClientMediaKeysCapabilitiesRobustnessTest, GetSupportedRobustnessLevelsSuccess)
{
    std::vector<std::string> levels;
    EXPECT_CALL(*m_mediaKeysCapabilitiesIpcMock, getSupportedRobustnessLevels(kKeySystem, _))
...
/**
 * Test that getSupportedRobustnessLevels returns failure if the IPC API fails.
 */
TEST_F(RialtoClientMediaKeysCapabilitiesRobustnessTest, GetSupportedRobustnessLevelsFailure)
{
    std::vector<std::string> levels;
    EXPECT_CALL(*m_mediaKeysCapabilitiesIpcMock, getSupportedRobustnessLevels(kKeySystem, _)).WillOnce(Return(false));
