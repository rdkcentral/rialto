...
/**
 * Test that a GST_MESSAGE_STATE_CHANGED message for non-pipeline object is not handled.
 */
TEST_F(GstDispatcherThreadTest, StateChangedToPausedNonPipelineObject)
{
