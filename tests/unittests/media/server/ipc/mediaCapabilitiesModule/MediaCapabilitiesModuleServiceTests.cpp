...
TEST_F(MediaCapabilitiesModuleServiceTests, shouldConnectClient)
{
    clientWillConnect();
    sendClientConnected();
}

TEST_F(MediaCapabilitiesModuleServiceTests, shouldGetSupportedAudioCapabilities)
{
    mediaPipelineWillGetSupportedAudioCapabilities();
    sendGetSupportedAudioCapabilitiesRequestAndReceiveResponse();
}

TEST_F(MediaCapabilitiesModuleServiceTests, shouldFailToGetSupportedAudioCapabilities)
{
    expectInvalidControlFailure();
    sendGetSupportedAudioCapabilitiesRequestAndExpectFailure();
}

TEST_F(MediaCapabilitiesModuleServiceTests, shouldGetSupportedVideoCapabilities)
{
    mediaPipelineWillGetSupportedVideoCapabilities();
    sendGetSupportedVideoCapabilitiesRequestAndReceiveResponse();
}

TEST_F(MediaCapabilitiesModuleServiceTests, shouldFailToGetSupportedVideoCapabilities)
{
    expectInvalidControlFailure();
