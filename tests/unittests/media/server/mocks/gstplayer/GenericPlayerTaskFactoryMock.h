...
public:
    ...
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createSetVolume, (GenericPlayerContext & context, double volume),
                (const, override));
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createSetMute, (GenericPlayerContext &context,
    ...
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createProcessAudioGap,
                ...
                (const, override));
    MOCK_METHOD(std::unique_ptr<IPlayerTask>, createSetTextTrackIdentifier, (GenericPlayerContext &context,
