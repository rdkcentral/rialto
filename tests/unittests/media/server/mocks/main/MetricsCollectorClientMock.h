...
#ifndef FIREBOLT_RIALTO_SERVER_METRICS_COLLECTOR_CLIENT_MOCK_H_
#define FIREBOLT_RIALTO_SERVER_METRICS_COLLECTOR_CLIENT_MOCK_H_
...
#endif // FIREBOLT_RIALTO_SERVER_METRICS_COLLECTOR_CLIENT_MOCK_H_
