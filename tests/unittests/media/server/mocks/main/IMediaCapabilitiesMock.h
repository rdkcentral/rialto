...
#ifndef FIREBOLT_RIALTO_I_MEDIA_CAPABILITIES_MOCK_H_
#define FIREBOLT_RIALTO_I_MEDIA_CAPABILITIES_MOCK_H_
...
{
class IMediaCapabilitiesMock : public IMediaCapabilities
{
public:
...
#endif // FIREBOLT_RIALTO_I_MEDIA_CAPABILITIES_MOCK_H_
