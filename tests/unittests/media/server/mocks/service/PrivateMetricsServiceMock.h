...
#ifndef FIREBOLT_RIALTO_SERVER_SERVICE_PRIVATE_METRICS_SERVICE_MOCK_H_
#define FIREBOLT_RIALTO_SERVER_SERVICE_PRIVATE_METRICS_SERVICE_MOCK_H_
...
{
class PrivateMetricsServiceMock : public IPrivateMetricsService
{
public:
    MOCK_METHOD(void, clientReady,
...
#endif // FIREBOLT_RIALTO_SERVER_SERVICE_PRIVATE_METRICS_SERVICE_MOCK_H_
