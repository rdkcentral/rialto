...
#ifndef FIREBOLT_RIALTO_SERVER_IPC_MEDIA_CAPABILITIES_MODULE_SERVICE_MOCK_H_
#define FIREBOLT_RIALTO_SERVER_IPC_MEDIA_CAPABILITIES_MODULE_SERVICE_MOCK_H_
...
{
class MediaCapabilitiesModuleServiceMock : public IMediaCapabilitiesModuleService
{
public:
    MediaCapabilitiesModuleServiceMock() = default;
    virtual ~MediaCapabilitiesModuleServiceMock() = default;
...
#endif // FIREBOLT_RIALTO_SERVER_IPC_MEDIA_CAPABILITIES_MODULE_SERVICE_MOCK_H_
