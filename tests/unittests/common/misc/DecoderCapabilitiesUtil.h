...
#ifndef FIREBOLT_RIALTO_DECODER_CAPABILITIES_UTIL_H_
#define FIREBOLT_RIALTO_DECODER_CAPABILITIES_UTIL_H_
...
#endif // FIREBOLT_RIALTO_DECODER_CAPABILITIES_UTIL_H_
