...
#ifndef FIREBOLT_RIALTO_WRAPPERS_JSON_CPP_WRAPPER_MOCK_H_
#define FIREBOLT_RIALTO_WRAPPERS_JSON_CPP_WRAPPER_MOCK_H_
...
#endif // FIREBOLT_RIALTO_WRAPPERS_JSON_CPP_WRAPPER_MOCK_H_
