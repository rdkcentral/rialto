...
#ifndef FIREBOLT_RIALTO_WRAPPERS_LINUX_WRAPPER_MOCK_H_
#define FIREBOLT_RIALTO_WRAPPERS_LINUX_WRAPPER_MOCK_H_
...
#endif // FIREBOLT_RIALTO_WRAPPERS_LINUX_WRAPPER_MOCK_H_
