...
#ifndef FIREBOLT_RIALTO_WRAPPERS_OCDM_SESSION_MOCK_H_
#define FIREBOLT_RIALTO_WRAPPERS_OCDM_SESSION_MOCK_H_
...
public:
    ...
    MOCK_METHOD(MediaKeyErrorStatus, decryptBuffer, (GstBuffer * encrypted, GstCaps *caps), (override));
    ...
    MOCK_METHOD(MediaKeyErrorStatus, selectKeyId, (uint8_t keyLength, const uint8_t keyId[]), (override));
...
#endif // FIREBOLT_RIALTO_WRAPPERS_OCDM_SESSION_MOCK_H_
