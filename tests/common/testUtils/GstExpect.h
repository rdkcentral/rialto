...
#ifndef FIREBOLT_RIALTO_SERVER_TESTCOMMON_GST_EXPECT_H_
#define FIREBOLT_RIALTO_SERVER_TESTCOMMON_GST_EXPECT_H_
...
#endif // FIREBOLT_RIALTO_SERVER_TESTCOMMON_GST_EXPECT_H_
