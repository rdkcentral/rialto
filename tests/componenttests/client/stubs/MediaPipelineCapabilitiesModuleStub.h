...
{
class MediaPipelineCapabilitiesModuleStub
{
public:
    explicit MediaPipelineCapabilitiesModuleStub(
        const std::shared_ptr<::firebolt::rialto::MediaPipelineCapabilitiesModule> &mediaPipelineCapabilitiesModuleMock);
    ~MediaPipelineCapabilitiesModuleStub();

protected:
    std::shared_ptr<::firebolt::rialto::MediaPipelineCapabilitiesModule> m_mediaPipelineCapabilitiesModuleMock;
};
} // namespace firebolt::rialto::client::ct

#endif // FIREBOLT_RIALTO_CLIENT_CT_MEDIA_PIPELINE_CAPABILITIES_MODULE_STUB_H_
