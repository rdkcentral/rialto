...
public:
    ...
    ::firebolt::rialto::GetMetricSystemDataResponse
    getMetricSystemDataResponse(const firebolt::rialto::MediaKeyErrorStatus &status, const std::vector<uint8_t> &buffer)
    {
