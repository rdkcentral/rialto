...
bool ClientStub::connect()
{
    ...
    setupSubscriptions<
        firebolt::rialto::PlaybackStateChangeEvent, firebolt::rialto::NetworkStateChangeEvent,
        firebolt::rialto::PositionChangeEvent, firebolt::rialto::NeedMediaDataEvent, firebolt::rialto::QosEvent,
        firebolt::rialto::BufferUnderflowEvent, firebolt::rialto::FirstFrameReceivedEvent,
        firebolt::rialto::PlaybackErrorEvent, firebolt::rialto::SetLogLevelsEvent, firebolt::rialto::SourceFlushedEvent,
        firebolt::rialto::WebAudioPlayerStateEvent, firebolt::rialto::ApplicationStateChangeEvent,
        firebolt::rialto::PingEvent, firebolt::rialto::LicenseRequestEvent, firebolt::rialto::LicenseRenewalEvent,
