...
- [x] 0.3 Update all includes of both headers in `media/`, `wrappers/`, and `tests/` to resolve through `RialtoCommonPublic`.
- [x] 0.4 Verify `IYamlCppWrapper.h` resolves both headers from the new location.
