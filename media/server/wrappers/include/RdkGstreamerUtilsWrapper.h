...
#ifndef FIREBOLT_RIALTO_SERVER_RDK_GSTREAMER_UTILS_WRAPPER_H_
#define FIREBOLT_RIALTO_SERVER_RDK_GSTREAMER_UTILS_WRAPPER_H_
...
public:
    ...
    void deepElementAdded(PlaybackGroupPrivate *playbackGroup, GstBin *pipeline, GstBin *bin,
                          GstElement *element) const override;
};
} // namespace firebolt::rialto::server

#endif // FIREBOLT_RIALTO_SERVER_RDK_GSTREAMER_UTILS_WRAPPER_H_
