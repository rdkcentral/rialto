...
{
    return std::make_unique<generic::AttachSamples>(context, player, mediaSegments);
}
...
{
    return std::make_unique<generic::AttachSource>(context, m_gstWrapper, m_glibWrapper, m_rdkGstreamerUtilsWrapper,
                                                   player, source);
}
...
{
    return std::make_unique<generic::DeepElementAdded>(context, player, m_gstWrapper, m_glibWrapper, pipeline, bin,
                                                       element);
}

std::unique_ptr<IPlayerTask> GenericPlayerTaskFactory::createEnoughData(GenericPlayerContext &context, GstAppSrc *src) const
{
    return std::make_unique<generic::EnoughData>(context, src);
}
...
{
    return std::make_unique<generic::Eos>(context, player, m_gstWrapper, type);
}
...
{
    return std::make_unique<generic::FinishSetupSource>(context, player, m_client);
}
...
{
    return std::make_unique<generic::SetPosition>(context, player, m_client, m_gstWrapper, position);
}
...
std::unique_ptr<IPlayerTask> GenericPlayerTaskFactory::createSetupElement(GenericPlayerContext &context,
                                                                          ...
                                                                          GstElement *element) const
{
    return std::make_unique<generic::SetupElement>(context, m_gstWrapper, m_glibWrapper, player, element);
}
...
{
    return std::make_unique<generic::SetupSource>(context, player, source);
}
...
{
    return std::make_unique<generic::Underflow>(player, m_client, underflowFlag, underflowEnabled);
}
...
{
    return std::make_unique<generic::UpdatePlaybackGroup>(context, m_gstWrapper, m_glibWrapper, typefind, caps);
}

std::unique_ptr<IPlayerTask> GenericPlayerTaskFactory::createRenderFrame(GenericPlayerContext &context) const
{
    return std::make_unique<generic::RenderFrame>(context, m_gstWrapper, m_glibWrapper);
}
