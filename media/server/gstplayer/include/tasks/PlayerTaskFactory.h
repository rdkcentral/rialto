...
public:
    ...
    std::unique_ptr<IPlayerTask> createRemoveSource(PlayerContext &context,
                                                    const firebolt::rialto::MediaSourceType &type) const override;
    ...
    std::unique_ptr<IPlayerTask> createUnderflow(IGstPlayerPrivate &player, bool &underflowFlag,
