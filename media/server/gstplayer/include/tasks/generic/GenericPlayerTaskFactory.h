...
public:
    ...
    std::unique_ptr<IPlayerTask> createSetVolume(GenericPlayerContext &context, double targetVolume, uint32_t volumeDuration, firebolt::rialto::EaseType easeType) const override;
