...
public:
    ...
    createAttachSource(GenericPlayerContext &context, const std::unique_ptr<IMediaPipeline::MediaSource> &source) const override;
    ...
    std::unique_ptr<IPlayerTask> createFinishSetupSource(GenericPlayerContext &context, IGstGenericPlayerPrivate &player) const override;
    ...
    std::unique_ptr<IPlayerTask> createPause(IGstGenericPlayerPrivate &player) const override;
    ...
    std::unique_ptr<IPlayerTask> createStop(GenericPlayerContext &context, IGstGenericPlayerPrivate &player) const override;
    std::unique_ptr<IPlayerTask> createUnderflow(IGstGenericPlayerPrivate &player, bool &underflowFlag) const override;
