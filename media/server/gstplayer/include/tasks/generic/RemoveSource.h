...
#ifndef FIREBOLT_RIALTO_SERVER_GENERIC_REMOVE_SOURCE_H_
#define FIREBOLT_RIALTO_SERVER_GENERIC_REMOVE_SOURCE_H_
...
#endif // FIREBOLT_RIALTO_SERVER_GENERIC_REMOVE_SOURCE_H_
