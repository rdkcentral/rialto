...
#ifndef FIREBOLT_RIALTO_SERVER_GST_PLAYER_INIT_H_
#define FIREBOLT_RIALTO_SERVER_GST_PLAYER_INIT_H_
...
{
public:
    GstPlayerInit() = default;
    virtual ~GstPlayerInit() = default;

    GstPlayerInit(const GstPlayerInit &) = delete;
    GstPlayerInit &operator=(const GstPlayerInit &) = delete;
    GstPlayerInit(GstPlayerInit &&) = delete;
    GstPlayerInit &operator=(GstPlayerInit &&) = delete;
...
#endif // FIREBOLT_RIALTO_SERVER_GST_PLAYER_INIT_H_
