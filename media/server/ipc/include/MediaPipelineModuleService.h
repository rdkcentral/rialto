...
public:
    ...
    void setTextTrackIdentifier(::google::protobuf::RpcController *controller, const ::firebolt::rialto::SetTextTrackIdentifierRequest *request,
                 ::firebolt::rialto::SetTextTrackIdentifierResponse *response, ::google::protobuf::Closure *done) override;
    void getTextTrackIdentifier(::google::protobuf::RpcController *controller, const ::firebolt::rialto::GetTextTrackIdentifierRequest *request,
                 ::firebolt::rialto::GetTextTrackIdentifierResponse *response, ::google::protobuf::Closure *done) override;
