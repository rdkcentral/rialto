...
{
    RIALTO_SERVER_LOG_DEBUG("notifyPosition called: session=%d position=%lld", m_sessionId,
...
{
    RIALTO_SERVER_LOG_DEBUG("notifyPlaybackInfo called: session=%d position=%lld volume=%f", m_sessionId,
