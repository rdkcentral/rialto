...
{
RialtoControlClient::RialtoControlClient(const std::shared_ptr<::firebolt::rialto::ipc::IClient> &ipcClient)
    : m_ipcClient{ipcClient}
{
}

void RialtoControlClient::notifyApplicationState(ApplicationState state)
{
