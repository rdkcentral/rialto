...
#ifndef FIREBOLT_RIALTO_SERVER_I_MEDIA_PIPELINE_CAPABILITIES_H_
#define FIREBOLT_RIALTO_SERVER_I_MEDIA_PIPELINE_CAPABILITIES_H_
...
#endif // FIREBOLT_RIALTO_SERVER_I_MEDIA_PIPELINE_CAPABILITIES_H_