...
bool MediaPipeline::processAudioGap(int64_t position, uint32_t duration, int64_t discontinuityGap)
{
    RIALTO_CLIENT_LOG_DEBUG("entry:");

    return m_mediaPipelineIpc->processAudioGap(position, duration, discontinuityGap);
}
